...
PROMOTION_CHECKLIST = [
    ...
    "in-sample report).",
    "The candidate's top-band (63+) T+5 mean CI sits above the baseline's, "
    "with n >= 20 in both.",
    "No band's hit rate regresses by more than 5 points without a "
    "documented trade-off rationale.",
